	...
	CoverageMode_(CoverageMode)
{
	...
	bool isBuildingsGood2 = Tool_ReadDistributionObstacles_binary(FolderPath_step1+"build/data_step1_part2_tool_obstacles_binary_RegionOfInterst.txt");
	...
	// step 1 - 3 : import Robots Parameters
	bool isRobotParametersGood = Tool_ReadRobotParameters("../../alice_step2_UAVsCoverage_part5_unlimitedUAVs/data_Robots_parameters.txt");
